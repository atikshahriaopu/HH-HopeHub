...
const NGONavbar = ({ userName = 'Organization', onMenuClick }) => {
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {/* Map Button */}
            <Link to="/map" className="flex items-center space-x-1 p-2 sm:px-3 sm:py-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors duration-200">
            ...
            <Link to="/alert" className="flex items-center space-x-1 p-2 sm:px-3 sm:py-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition-colors duration-200">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <span className="text-sm font-medium hidden sm:inline">Alert</span>
            </Link>
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  ...
                  <div className="px-4 py-2 border-t border-gray-200">
                    <Link to="/ngo/notifications" className="text-sm text-green-600 hover:text-green-700 font-medium">
