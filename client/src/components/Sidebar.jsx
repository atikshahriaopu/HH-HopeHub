...
const Sidebar = ({ userType = 'volunteer' }) => {
  ...
  const volunteerLinks = [
    ...
    { name: 'Map', path: '/volunteer/map', icon: 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7' },
  ];
  ...
  const ngoLinks = [
    ...
    { name: 'Reports', path: '/ngo/reports', icon: 'M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  ];

  const links = userType === 'volunteer' ? volunteerLinks : ngoLinks;
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 mx-4 mb-6 bg-gradient-to-br from-blue-50 to-green-50 rounded-lg">
          <h3 className="text-sm font-semibold text-gray-900 mb-2">
            {userType === 'volunteer' ? 'Your Impact' : 'Quick Stats'}
          </h3>
          {userType === 'volunteer' ? (
