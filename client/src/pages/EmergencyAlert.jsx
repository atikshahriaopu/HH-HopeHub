...
const EmergencyAlert = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3 pt-4 border-t">
                ...
                {selectedAlert.status === 'Resolved' && (
                  <>
                    <Button variant="outline" fullWidth onClick={handleViewReport}>
                      View Report
                    </Button>
      ...
      {isReportModalOpen && selectedAlert && (
        ...
        >
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Emergency Response Report</h2>
                <p className="text-gray-600">{selectedAlert.type} - {selectedAlert.location}</p>
              </div>
              <button 
                onClick={() => setIsReportModalOpen(false)}
                className="text-gray-400 hover:text-gray-600 transition-colors"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-green-50 rounded-lg p-4 border-2 border-green-200">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-green-900">Emergency Resolved</h3>
                    <p className="text-sm text-green-700">Successfully completed on {selectedAlert.time}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white border-2 border-gray-200 rounded-lg p-4 text-center">
                    <p className="text-3xl font-bold text-blue-600">{selectedAlert.responded}</p>
                    <p className="text-sm text-gray-600 mt-1">Volunteers</p>
                  </div>
                  <div className="bg-white border-2 border-gray-200 rounded-lg p-4 text-center">
                    <p className="text-3xl font-bold text-green-600">4.5h</p>
                  ...
                  <div className="bg-white border-2 border-gray-200 rounded-lg p-4 text-center">
                    <p className="text-3xl font-bold text-orange-600">18h</p>
                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 pb-8">
                      <p className="font-medium text-gray-900">Alert Sent</p>
                      <p className="text-sm text-gray-600">Emergency alert broadcast to 150 nearby volunteers</p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 pb-8">
                      <p className="font-medium text-gray-900">Volunteers Mobilized</p>
                      <p className="text-sm text-gray-600">{selectedAlert.responded} volunteers confirmed and deployed to location</p>
                      <p className="text-xs text-gray-500 mt-1">1.5 hours ago</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 pb-8">
                      <p className="font-medium text-gray-900">Relief Operations</p>
                      <p className="text-sm text-gray-600">First aid provided, supplies distributed, temporary shelter established</p>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Mission Complete</p>
                      <p className="text-sm text-gray-600">All affected individuals secured, situation stabilized</p>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-4">Activities Completed</h3>
                <div className="grid md:grid-cols-2 gap-3">
                  {[
                    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Emergency medical care provided', color: 'green' },
                    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Food and water distributed', color: 'green' },
                    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Temporary shelter established', color: 'green' },
                    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Transportation arranged for 127 people', color: 'green' },
                    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Coordination with local authorities', color: 'green' },
                    { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Safety assessment completed', color: 'green' },
                  ].map((activity, index) => (
                    <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <svg className={`w-5 h-5 text-${activity.color}-600 flex-shrink-0`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="space-y-3">
                  {selectedAlert.volunteers.map((volunteer, index) => (
                    <div key={index} className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-semibold text-gray-900">6 hours</p>
              ...
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                <h3 className="font-semibold text-gray-900 mb-3">Resources Deployed</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <p className="text-sm text-gray-600">Medical Supplies</p>
                    <p className="text-lg font-semibold text-gray-900">45 kits</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Food Packages</p>
                    <p className="text-lg font-semibold text-gray-900">200 units</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Emergency Vehicles</p>
                    <p className="text-lg font-semibold text-gray-900">8 vehicles</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-200">
                ...
                <div className="space-y-3">
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <p className="text-sm text-gray-700 italic">"The response was incredibly fast and professional. Thank you to all volunteers who helped our community."</p>
                    <p className="text-xs text-gray-500 mt-2">- Community Member</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-4 border-t">
                ...
                <Button variant="outline" fullWidth onClick={handleShareReport}>
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" />
                  </svg>
                  Share Report
                </Button>
                <Button variant="primary" fullWidth onClick={() => setIsReportModalOpen(false)}>
                  Close
                </Button>
              </div>
            </div>
      ...
      {/* Share Report Modal */}
      {isShareReportModalOpen && selectedAlert && (
        <div 
          className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50"
          onClick={() => setIsShareReportModalOpen(false)}
        >
          <div 
            className="bg-white rounded-2xl p-6 max-w-md w-full"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-1">Share Emergency Report</h2>
                <p className="text-sm text-gray-600">Share this response report</p>
              </div>
              <button 
                onClick={() => setIsShareReportModalOpen(false)}
                className="text-gray-400 hover:text-gray-600 transition-colors"
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                <p className="font-semibold text-gray-900 mb-1">Emergency Response Report</p>
                <p className="text-sm text-gray-700">{selectedAlert.type} - {selectedAlert.location}</p>
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full font-medium">Resolved</span>
                  <span className="text-xs text-gray-600">{selectedAlert.responded} volunteers responded</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <button className="flex items-center gap-3 p-3 w-full border-2 border-gray-200 rounded-lg hover:border-purple-500 hover:bg-purple-50 transition-all text-left">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Send report by email</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Copy Link</p>
                    <p className="text-xs text-gray-600">Copy report URL</p>
                  </div>
                </button>
              </div>
            </div>
