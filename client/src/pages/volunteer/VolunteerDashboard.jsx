      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-blue-50">
            ...
            <Button variant="outline" size="sm" fullWidth onClick={() => navigate('/volunteer/profile')}>Complete Profile</Button>
          </Card>
                ...
                <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-yellow-700 mt-1">This {selectedOpportunity.type} mission requires dedication and teamwork. You'll work alongside experienced volunteers and NGO staff to make a real impact.</p>
                    </div>
                  </div>
                </div>
              </div>
