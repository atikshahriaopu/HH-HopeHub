    ...
    <DashboardLayout userType="volunteer" userName="Sarah Johnson">
      <div className="flex flex-col h-[calc(100vh-180px)]">
        ...
        <div className="flex-1 flex gap-4 overflow-hidden">
              ...
              {filteredLocations.map((location) => (
                ...
                >
                  ...
                  {selectedMarker === location.id && (
                    <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 w-64 bg-white rounded-lg shadow-xl p-4 z-10 border border-gray-200">
                      <button 
              ...
              <div className="absolute bottom-4 left-4 bg-white bg-opacity-95 p-4 rounded-lg shadow-lg max-w-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-900 mb-1">Map Integration Ready</h4>
                    <p className="text-sm text-gray-600">
                      This placeholder will be replaced with Google Maps, Mapbox, or OpenStreetMap integration
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="w-80 overflow-y-auto" padding={false}>
            <div className="p-4 border-b border-gray-200 bg-gray-50">
              <h2 className="font-bold text-gray-900">Nearby Locations</h2>
              <p className="text-sm text-gray-600">
            ...
            <div className="p-4 space-y-3">
              {filteredLocations
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className={`${getMarkerColor(location.type, location.status)} text-white rounded-lg p-2 flex-shrink-0`}>
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        {location.type === 'emergency' ? (
                          <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                        ) : (
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700">Shelter</span>
              </div>
              <div className="flex items-center gap-2">
